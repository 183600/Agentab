    ...
    try {
      ...
      while (iteration < this.maxIterations && this.isRunning) {
        ...
        if (action.action === 'execute') {
          this.progress.transitionTo(ExecutionPhase.EXECUTING, { code: action.code.substring(0, 100) });
      ...
      if (iteration >= this.maxIterations) {
        ...
        logger.warn('Agent reached max iterations', { executionId, maxIterations: this.maxIterations });
      }
