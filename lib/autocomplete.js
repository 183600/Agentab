...
export class AutocompleteEngine {
  ...
  initDOMKeywords() {
    ...
    const elementProps = [
      ...
      'className', 'classList', 'style', 'attributes', 'children',
  ...
  initAgentKeywords() {
    ...
    const methods = [
      { name: 'waitForElement', template: 'await __chromeAgent.waitForElement(${1:selector}, ${2:timeout})' },
      { name: 'typeText', template: 'await __chromeAgent.typeText(${1:selector}, ${2:text}, ${3:delay})' },
      { name: 'clickElement', template: 'await __chromeAgent.clickElement(${1:selector}, ${2:retries})' },
      ...
      { name: 'fillForm', template: 'await __chromeAgent.fillForm({\n\t${1:selector}: ${2:value}\n})' }
    ];
  ...
  initJSKeywords() {
    ...
    const jsKeywords = [
      ...
      'debugger', 'default', 'do', 'else', 'export', 'extends', 'finally',
      'for', 'function', 'if', 'import', 'let', 'new', 'return', 'switch',
  ...
  getCompletions(code, position, context = {}) {
    ...
    } else if (trigger === 'querySelector' || trigger === 'querySelectorAll' || this.looksLikeSelector(currentWord)) {
      // Selector completion
  ...
  getKeywordCompletions(word) {
    ...
    // Add common patterns
    const patterns = [
      { label: 'document.querySelector', insertText: 'document.querySelector(\'${1:selector}\')', documentation: 'Query selector' },
      { label: 'document.querySelectorAll', insertText: 'document.querySelectorAll(\'${1:selector}\')', documentation: 'Query all selectors' },
      { label: 'async function', insertText: 'async function ${1:name}(${2:params}) {\n\t${3}\n}', documentation: 'Async function' },
      { label: 'arrow function', insertText: '(${1:params}) => ${2:expression}', documentation: 'Arrow function' },
  ...
  getSelectorCompletions(word, _context = {}) {
    ...
    commonSelectors.forEach(({ selector, description }) => {
      const selectorText = selector.startsWith('#') || selector.startsWith('.') ? selector : `'${selector}'`;
