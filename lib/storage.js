...
const StorageManager = {
  ...
  /**
   * Update an existing task with version history
   * @param {string} id - Task ID
   * @param {Object} updates - Fields to update
   * @param {Object} options - Update options
   * @param {boolean} options.keepHistory - Whether to keep version history (default true)
  ...
  async updateTask(id, updates, options = {}) {
    ...
    // Create history entry if content changed and history is enabled
