...
const StorageManager = {
  ...
  async getApiKey() {
    ...
    if (result.apiKeyEncrypted) {
      try {
        ...
        // Fall through to try unencrypted version
      }
    }
    
    // Return unencrypted version (for backward compatibility)
  ...
  async saveApiKey(key) {
    ...
    try {
      ...
      console.error('Failed to encrypt API key, storing as plain text:', error);
      // Fallback to unencrypted storage (should not happen in normal circumstances)
