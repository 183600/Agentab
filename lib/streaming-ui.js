...
export class StreamingResponseUI {
  ...
  createCodeBlockContainer() {
    ...
    header.innerHTML = `
      <span class="code-language">${escapeHtml(this.codeLanguage || 'code')}</span>
      <span class="code-status">streaming...</span>
    ...
    header.querySelector('.copy-code-btn').addEventListener('click', () => {
      ...
      header.querySelector('.code-status').textContent = 'copied!';
      setTimeout(() => {
        header.querySelector('.code-status').textContent = '';
      }, 2000);
    });
  ...
  showThinking(message = 'Thinking...') {
    ...
    thinkingDiv.innerHTML = `
      ...
      <span class="thinking-message">${escapeHtml(message)}</span>
    `;
  ...
  complete() {
    ...
    completeDiv.innerHTML = `
      ...
      <span class="complete-text">Response complete</span>
    `;
