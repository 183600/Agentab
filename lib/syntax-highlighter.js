...
export class SyntaxHighlighter {
  constructor(options = {}) {
    ...
    this.patterns = {
      ...
      // Keywords
      keywords: /\b(const|let|var|function|return|if|else|for|while|do|switch|case|break|continue|try|catch|finally|throw|new|class|extends|import|export|from|default|async|await|yield|typeof|instanceof|in|of|this|super|null|undefined|true|false|void|delete|static|get|set)\b/g,

      // Built-in objects
      builtins: /\b(Array|Object|String|Number|Boolean|Function|Symbol|Map|Set|WeakMap|WeakSet|Promise|Proxy|Reflect|JSON|Math|Date|RegExp|Error|TypeError|SyntaxError|ReferenceError|console|window|document|fetch|setTimeout|setInterval|clearTimeout|clearInterval|requestAnimationFrame|cancelAnimationFrame)\b/g,
  ...
  highlight(code) {
    ...
    highlighted = highlighted
      ...
      .replace(this.patterns.punctuation, `<span style="${this.getStyle('punctuation')}">$1</span>`);
...
export class CodeEditorWithHighlight {
  ...
  init() {
    ...
    this.textarea.addEventListener('keydown', e => {
      if (e.key === 'Tab') {
        ...
        this.textarea.selectionStart = this.textarea.selectionEnd = start + this.options.highlighter.options.tabSize;
        this.updateHighlight();
      }
    });
  ...
  createOverlay() {
    ...
    const copyStyles = [
      ...
      'border', 'borderWidth', 'boxSizing', 'whiteSpace', 'wordWrap', 'wordBreak'
    ];
