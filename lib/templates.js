  ...
  initializeBuiltIn() {
    const builtInTemplates = [
      ...
      },
      {
        ...
        tags: ['表单', '填充'],
        variables: [
          { name: 'data', description: '表单数据 (JSON格式)', default: '{}' }
        ],
      ...
      // === Navigation Templates ===
      {
        ...
        tags: ['点击', '按钮', '导航'],
        variables: [
          { name: 'buttonText', description: '按钮文本', default: '提交' }
        ],
        examples: ['适用于各种操作按钮']
      },
      {
        ...
        tags: ['滚动', '加载', '无限滚动'],
        variables: [
          { name: 'maxPages', description: '最大加载次数', default: '5' }
        ],
      ...
      },
      {
        ...
        tags: ['导航', '菜单'],
        variables: [
          { name: 'menuItem', description: '菜单项名称', default: '' }
        ],
        examples: ['适用于网站导航']
      },
      ...
      },
      {
        ...
        tags: ['分析', '关键词', '内容'],
        variables: [
          { name: 'count', description: '关键词数量', default: '10' }
        ],
      ...
      },
      {
        ...
        tags: ['检查', '元素', '验证'],
        variables: [
          { name: 'selector', description: 'CSS选择器或元素描述', default: '.product' }
        ],
...
return elements.length;`,
      ...
      },
      {
        ...
        tags: ['测试', 'UI', '状态'],
        variables: [
          { name: 'element', description: '元素描述', default: '主要按钮' }
        ],
        examples: ['适用于UI状态验证']
      }
    ];
