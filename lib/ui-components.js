...
export class AgentUI {
  ...
  pruneOutputEntries() {
    ...
    const removeCount = Math.min(pruneBatchSize, children.length - maxOutputEntries + pruneBatchSize);
    ...
    console.debug(`[AgentUI] Pruned ${removeCount} output entries, current count: ${this.outputCount}`);
  }
